# -*- coding: utf-8 -*-
"""
Created on Tue Apr 26 11:18:05 2022
...
SSP_path = r"C:\UUstudy\assignment\Master thesis\Dataprocess\Frequency_crop\rice2"
ssp_path = []
...
threshold = ['32','34','35','36','38']

for ssp in SSP:
    for thre in threshold:
        
        Re_search = re.compile(ssp + '.*' + thre)
        ...
        file_path = r"C:\UUstudy\assignment\Master thesis\Dataprocess\Frequency_crop\GCMs\GCMs_rice2"
        file_name = 'Mean_fre_GCMs_' + 'rice2' + ssp + '_' + thre + '.nc'
        
        file_mean = nc.Dataset(os.path.join(file_path,file_name),'w',format=('NETCDF4'))
