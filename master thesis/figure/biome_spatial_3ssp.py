...
file1 = nc.Dataset(r'C:\UUstudy\assignment\Master thesis\Dataprocess\Frequency_biome\0.5x0.5\GCMs\GCMsssp126_90th.nc','r')
file2 = nc.Dataset(r'C:\UUstudy\assignment\Master thesis\Dataprocess\Frequency_biome\0.5x0.5\GCMs\GCMsssp370_90th.nc','r')
file3 = nc.Dataset(r'C:\UUstudy\assignment\Master thesis\Dataprocess\Frequency_biome\0.5x0.5\GCMs\GCMsssp585_90th.nc','r')
...
colors2 = ['deepskyblue']
final_color = colors2 + sns_colors
cmap = mpl.colors.ListedColormap(final_color)
cmap.set_extremes(over = sns_colors[6])
norm = mpl.colors.BoundaryNorm([0,36,60,100,150,200,250,300], cmap.N-1)
...
fig.text(0.06,0.23, s = 'Threshold = 90th',fontsize = 8, fontweight = 'bold')
...
plt.savefig(r'C:\Users\54021\OneDrive\桌面\桌面\meeting\figure\figures_new\biome\3 ssp',dpi = 1200,bbox_inches = 'tight')
